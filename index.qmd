...
[**Statistica Inference II**]{.text-primary} provides an introduction to Bayesian approach to inference, covering prior and posterior distributions, classical one-parameter models, prior elicitation, posterior-based inference, MCMC methods, and Bayesian approaches to linear and generalized linear models.
